                    ...
                    <div className="lg:col-span-5 flex flex-col justify-center reveal-fade-up">
                        ...
                        <div className="space-y-4">
                            {content.about.differentiators.map((diff, index) => (
                                <div
                                    key={index}
                                    className="flex items-start gap-4 p-4 rounded-sm hover:bg-white/[0.03] hover:backdrop-blur-sm hover:shadow-md transition-all duration-355 border border-transparent hover:border-white/10 hover:border-l-[#2B807D] hover:border-l-4 group"
                                >
                                    <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-sm bg-[#2B807D]/15 text-gold border border-[#2B807D]/30 mt-0.5 group-hover:bg-[#2B807D] group-hover:text-white transition-colors">
