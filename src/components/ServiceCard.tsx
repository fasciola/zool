...
export function ServiceCard({ service }: ServiceCardProps) {
  ...
  const [imageStage, setImageStage] = useState(0); // 0: local public folder, 1: curated unsplash, 2: css gradient
  ...
  const handleInquire = () => {
    ...
    window.location.href = `https://wa.me/+971503626053?text=${message}`;
  };
